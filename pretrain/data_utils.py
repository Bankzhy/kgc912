...
from common.antlr_parsers.php.PhpLexer import PhpLexer
from common.antlr_parsers.javascript.JavaScriptLexer import JavaScriptLexer
# from code_tokenizers.ruby.ruby_tokenizer import RubyTokenizer
...
def tokenize_source(source, lang, use_regular=False):
    ...
    if lang == enums.LANG_PYTHON:
        fsource = convert_python_source_classical_summarization(source)
        # print("fs")
        # print(fsource)
        tokens = tokenize.generate_tokens(StringIO(fsource).readline)
